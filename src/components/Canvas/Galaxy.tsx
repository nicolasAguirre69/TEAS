...
interface GalaxyProps {
    ...
    transparent?: boolean;
    /** Ref al contenedor que captura eventos de mouse (ej: cuando la Galaxy está debajo de otra capa).
     * Permite que el efecto de seguimiento funcione aunque elementos con z-index cubran la Galaxy. */
...
export default function Galaxy({
    ...
    useEffect(() => {
        ...
        const eventTarget = mouseInteraction
            ? (trackingContainerRef?.current ?? ctn)
            : null;
